/*
 * SPDX-License-Indentifier: GPLv3
 *
...
TEST(intervalTest, overlapOverlapping) {
    ...
    EXPECT_TRUE(gdt::interval::overlaps(intvl1, intvl2));
    EXPECT_TRUE(gdt::interval::overlaps(intvl2, intvl1));
}
...
TEST(intervalTest, overlapDisjoint) {
    ...
    EXPECT_FALSE(gdt::interval::overlaps(intvl1, intvl2));
    EXPECT_FALSE(gdt::interval::overlaps(intvl2, intvl1));
}
...
TEST(intervalTest, overlapPartialOverlap) {
    ...
    EXPECT_TRUE(gdt::interval::overlaps(intvl1, intvl2));  // [10,25] overlaps [15,35]
    EXPECT_TRUE(gdt::interval::overlaps(intvl2, intvl3));  // [15,35] overlaps [20,40]
    EXPECT_TRUE(gdt::interval::overlaps(intvl1, intvl3));  // [10,25] overlaps [20,40] at [20,25]
