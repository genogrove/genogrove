...
TEST(genomicCoordinateTest, overlapSameStrandOverlapping) {
    ...
    EXPECT_TRUE(gdt::genomic_coordinate::overlaps(coord2, coord1));
}
...
TEST(genomicCoordinateTest, overlapSameStrandDisjoint) {
    ...
    EXPECT_FALSE(gdt::genomic_coordinate::overlaps(coord1, coord2));
    EXPECT_FALSE(gdt::genomic_coordinate::overlaps(coord2, coord1));
}
...
TEST(genomicCoordinateTest, overlapUnstrandedWithStranded) {
    ...
    EXPECT_FALSE(gdt::genomic_coordinate::overlaps(unstranded, plus_strand));
    EXPECT_FALSE(gdt::genomic_coordinate::overlaps(plus_strand, unstranded));

    EXPECT_FALSE(gdt::genomic_coordinate::overlaps(unstranded, minus_strand));
    EXPECT_FALSE(gdt::genomic_coordinate::overlaps(minus_strand, unstranded));

    EXPECT_TRUE(gdt::genomic_coordinate::overlaps(unstranded, all_strands));
    EXPECT_TRUE(gdt::genomic_coordinate::overlaps(all_strands, unstranded));
    EXPECT_TRUE(gdt::genomic_coordinate::overlaps(all_strands, plus_strand));
    EXPECT_TRUE(gdt::genomic_coordinate::overlaps(plus_strand, all_strands));
    EXPECT_TRUE(gdt::genomic_coordinate::overlaps(all_strands, minus_strand));
    EXPECT_TRUE(gdt::genomic_coordinate::overlaps(minus_strand, all_strands));
